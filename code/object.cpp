...
{
    irr::scene::ILightSceneNode* light = game_object::irr_scene->addLightSceneNode(0, light_position, irr::video::SColor(255, light_red, light_green, light_blue), light_radius);

    if (has_lens_flare == true)
    {
        irr::scene::IBillboardSceneNode* lens_flare = game_object::irr_scene->addBillboardSceneNode(0);
            lens_flare->setPosition(light_position);
        ...
        irr::scene::IBillboardSceneNode* lens_flare_center = game_object::irr_scene->addBillboardSceneNode(0);
            lens_flare_center->setPosition(light_position);
